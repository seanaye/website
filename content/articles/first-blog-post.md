...
<v-img class="my-10 rounded-xl shadow-md zoom data-zoomable" src="/blogImages/designThinking.png" id="zoom-default" alt="Photo"></v-img>
...
<v-img class="my-10 rounded-xl shadow-md zoom data-zoomable" src="/blogImages/sprint.png" alt="Photo"></v-img>
